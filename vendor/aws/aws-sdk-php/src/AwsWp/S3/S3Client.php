...
use AwsWp\Common\Client\AbstractClient;
use AwsWp\Common\Client\ClientBuilder;
use AwsWp\Common\Client\ExpiredCredentialsChecker;
use AwsWp\Common\Client\UploadBodyListener;
use AwsWp\Common\Enum\ClientOptions as Options;
use AwsWp\Common\Exception\RuntimeException;
use AwsWp\Common\Exception\InvalidArgumentException;
use AwsWp\Common\Signature\SignatureV4;
use AwsWp\Common\Model\MultipartUpload\AbstractTransfer;
use AwsWp\S3\Exception\AccessDeniedException;
use AwsWp\S3\Exception\Parser\S3ExceptionParser;
use AwsWp\S3\Exception\S3Exception;
use AwsWp\S3\Model\ClearBucket;
use AwsWp\S3\Model\MultipartUpload\AbstractTransfer as AbstractMulti;
use AwsWp\S3\Model\MultipartUpload\UploadBuilder;
use AwsWp\S3\Sync\DownloadSyncBuilder;
use AwsWp\S3\Sync\UploadSyncBuilder;
...
class S3Client extends AbstractClient
{
     ...
     * @param $config
     *
     * @return \AwsWp\Common\Signature\SignatureInterface
     ...
     *
     * @see AwsWp\S3\Model\MultipartUpload\UploadBuilder for more options and customization
     ...
     *       multipart upload.
     *
     * @see AwsWp\S3\S3Sync\S3Sync for more options and customization
     */
     ...
     *       Guzzle\Common\Event object with context.
     *
     * @see AwsWp\S3\S3Client::listObjects
     * @see AwsWp\S3\Model\ClearBucket For more options or customization
     * @return int Returns the number of deleted keys
