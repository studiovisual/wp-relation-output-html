...
namespace AwsWp\CloudSearchDomain;

use AwsWp\Common\Client\ClientBuilder;
use AwsWp\Common\Client\ThrottlingErrorChecker;
use AwsWp\Common\Client\UserAgentListener;
...
use AwsWp\Common\Exception\Parser\JsonQueryExceptionParser;
