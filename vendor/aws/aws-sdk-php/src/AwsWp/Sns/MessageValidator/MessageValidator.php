...
namespace AwsWp\Sns\MessageValidator;

use AwsWp\Common\Exception\RequiredExtensionNotLoadedException;
use AwsWp\Sns\MessageValidator\Exception\CannotGetPublicKeyFromCertificateException;
use AwsWp\Sns\MessageValidator\Exception\CertificateFromUnrecognizedSourceException;
use AwsWp\Sns\MessageValidator\Exception\InvalidMessageSignatureException;
use AwsWp\Sns\MessageValidator\Exception\SnsMessageValidatorException;
use Guzzle\Http\Url;
...
class MessageValidator
{
    ...
    private static $defaultHostPattern
        = '/^sns\.[a-zA-Z0-9\-]{3,}\.amazonAwsWp\.com(\.cn)?$/';
