...
use AwsWp\CloudTrail\Exception\CloudTrailException;
use Guzzle\Iterator\FilterIterator;

/**
 * The `AwsWp\CloudTrail\LogFileIterator` provides an easy way to iterate over log file generated by AWS CloudTrail.
...
class LogFileIterator extends \IteratorIterator
{
     ...
     * @throws \AwsWp\Common\Exception\InvalidArgumentException
