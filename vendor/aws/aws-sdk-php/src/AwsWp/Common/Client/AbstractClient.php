...
use AwsWp\Common\Exception\TransferException;
...
use AwsWp\Common\Signature\SignatureListener;
use AwsWp\Common\Waiter\WaiterClassFactory;
use AwsWp\Common\Waiter\CompositeWaiterFactory;
use AwsWp\Common\Waiter\WaiterFactoryInterface;
use AwsWp\Common\Waiter\WaiterConfigFactory;
...
abstract class AbstractClient extends Client implements AwsClientInterface
{
    ...
    /**
     * {@inheritdoc}
     * @throws \AwsWp\Common\Exception\TransferException
     */
