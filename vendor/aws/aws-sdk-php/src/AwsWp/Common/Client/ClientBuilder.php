...
namespace AwsWp\Common\Client;

use AwsWp\Common\Credentials\Credentials;
use AwsWp\Common\Credentials\CredentialsInterface;
use AwsWp\Common\Credentials\NullCredentials;
use AwsWp\Common\Enum\ClientOptions as Options;
use AwsWp\Common\Exception\ExceptionListener;
use AwsWp\Common\Exception\InvalidArgumentException;
use AwsWp\Common\Exception\NamespaceExceptionFactory;
use AwsWp\Common\Exception\Parser\DefaultXmlExceptionParser;
use AwsWp\Common\Exception\Parser\ExceptionParserInterface;
use AwsWp\Common\Iterator\AwsResourceIteratorFactory;
use AwsWp\Common\RulesEndpointProvider;
use AwsWp\Common\Signature\EndpointSignatureInterface;
use AwsWp\Common\Signature\SignatureInterface;
use AwsWp\Common\Signature\SignatureV2;
use AwsWp\Common\Signature\SignatureV3Https;
...
class ClientBuilder
{
    ...
    public function __construct($namespace = null)
    {
        ...
        $this->clientClass = 'AwsWp\Common\Client\DefaultClient';
     ...
     * version identifier string or an instance of AwsWp\Common\Signature\SignatureInterface.
     *
    ...
    protected function getSignature(ServiceDescription $description, Collection $config)
    {
        ...
        if (is_string($signature)) {
            ...
            throw new InvalidArgumentException('The provided signature is not '
                ...
                . 'AwsWp\\Common\\Signature\\SignatureInterface');
        }
