...
namespace AwsWp\Common\Exception;

use AwsWp\Common\Model\MultipartUpload\TransferStateInterface;

/**
 * Thrown when a {@see AwsWp\Common\MultipartUpload\TransferInterface} object encounters an error during transfer
 */
