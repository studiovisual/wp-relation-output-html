...
namespace AwsWp\Common\InstanceMetadata;

use AwsWp\Common\Enum\ClientOptions as Options;
use AwsWp\Common\Exception\InstanceProfileCredentialsException;
    ...
    public function getInstanceProfileCredentials()
    {
        try {
            ...
            $message = sprintf('Error retrieving credentials from the instance profile metadata server. When you are'
                ...
                . ' AwsWp\\Common\\Credentials\\CredentialsInterface object. (%s)', $e->getMessage());
