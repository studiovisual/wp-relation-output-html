...
namespace AwsWp\Common\Hash;

use AwsWp\Common\Enum\Size;
use AwsWp\Common\Exception\InvalidArgumentException;
use AwsWp\Common\Exception\LogicException;
...
class TreeHash implements ChunkHashInterface
{
    ...
    public static function fromChecksums(array $checksums, $inBinaryForm = false, $algorithm = self::DEFAULT_ALGORITHM)
    {
        ...
        $treeHash->checksums = $inBinaryForm ? $checksums : array_map('AwsWp\Common\Hash\HashUtils::hexToBin', $checksums);
